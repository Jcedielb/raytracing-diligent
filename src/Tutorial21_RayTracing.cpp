...
void Tutorial21_RayTracing::CreateSBT()
{
    ...
    struct InstanceHitGroup
    {
        ...
        {"Sphere Instance", "SpherePrimaryHit", "SphereShadowHit"},
        {"Sphere Instance 2", "SpherePrimaryHit", "SphereShadowHit"},
        {"Sphere Instance 3", "SpherePrimaryHit", "SphereShadowHit"}};
    ...
    for (int i = 0; i < NumSpheres; ++i)
    {
        ...
        m_pSBT->BindHitGroupForInstance(m_pTLAS, instanceName, PRIMARY_RAY_INDEX, "SpherePrimaryHit");
    }
    ...
    for (int i = 0; i < NumSpheres; ++i)
    {
        char instanceName[32];
        std::snprintf(instanceName, sizeof(instanceName), "NearSphere%d", i);
        m_pSBT->BindHitGroupForInstance(m_pTLAS, instanceName, SHADOW_RAY_INDEX, "SphereShadowHit");
    }
